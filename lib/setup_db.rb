...
class ReleaseDatabase
  FILEPATH = "source/20160406-record-collection.csv"
  ...
  def reset_schema!
    # table name: albums
    # label_code,artist,title,label,format,released,data_added
    # BLOG, TEXT, TEXT, TEXT, TEXT, INTEGER, TEXT
    # one table
  ...
  def load!
    ...
    # now that we have a prepared statement, let's iterate teh csv and use its values to populate our database
